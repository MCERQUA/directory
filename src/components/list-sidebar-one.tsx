...
export default function ListSidebarOne() {
  ...
  return (
    <>
        ...
        <Link to="#filterSlider" data-bs-toggle="offcanvas" data-bs-target="#filterSlider" aria-controls="filterSlider" className="fixed-bottom z-sticky d-lg-none filterButtons"><BsFunnel />Filter Options</Link>
    </>
