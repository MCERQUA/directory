import { BsCrosshair2,  BsFunnel,  BsSearch, BsStarFill } from 'react-icons/bs'
        ...
        <div className="map-content-bxo py-5">
            <div className="filterOption-02 mb-3">
                <div className="row align-items-start justify-content-center g-3">
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="form-group map-form position-relative mb-0">
            ...
            <div className="filterOptions-wrap d-flex justify-content-between align-items-center gap-2">
                ...
                <div className="filter-mobile d-lg-none flex-fill">
                    <Link to="#filterSlider" data-bs-toggle="offcanvas" data-bs-target="#filterSlider" aria-controls="filterSlider" className="btn btn-md btn-light-primary full-width"><BsFunnel className="me-2"/>Filter Option</Link>
                </div>
                
                <div className="filterOptions-wrap d-flex justify-content-between align-items-center gap-2">
                    <div className="filter-mobile d-lg-none">

                        <Link to="#filterSlider" data-bs-toggle="offcanvas" data-bs-target="#filterSlider" aria-controls="filterSlider" className="btn btn-md btn-light-primary rounded-pill"><BsFunnel className="me-2"/>Filter Option</Link>
                    </div>
                    
                    <div className="filter-desktop d-none d-lg-block">
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <Link to="#" className="py-2 px-3 dropdown-toggle toogleDrops" id="catsfilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                Categories
                            </Link>
                        ...
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <Link to="#dropdown" className="py-2 px-3 dropdown-toggle toogleDrops" id="ratingsfilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                Rating Filter
                            </Link>
                            <div className="dropdown-menu border shadow-sm">
                                <div className="card rounded-3">
                        ...
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <Link to="#dropdown" className="py-2 px-3 dropdown-toggle toogleDrops" id="pricefilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                Price Filter
                            </Link>
                        ...
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <Link to="#distancefilter" className="py-2 px-3 dropdown-toggle toogleDrops" id="distancefilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                Distance
                            </Link>
                            <div className="dropdown-menu pt-2 border-0 shadow-sm">
                                <div className="card rounded-3">
                        ...
                        <div className="dropdown d-inline-flex p-0 me-1">
                            <Link to="#morefilter" className="py-2 px-3 dropdown-toggle toogleDrops" id="morefilter" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
                                More Filter
                            </Link>
                            <div className="dropdown-menu pt-2 border-0 shadow-sm">
                                <div className="card rounded-3">
