                ...
                <div className="col-xl-6 col-lg-6 col-md-6">
                    <div className="elementWrap">
                        ...
                        <div className="elementContent">
                            ...
                            <div className="alert alert-primary alert-dismissible fade show">You should check in on some of those fields below.<Link to="#" className="close" data-bs-dismiss="alert" aria-label="Close"></Link></div>
                        </div>
                    </div>
                </div>
